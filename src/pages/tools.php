...
?>
	...
	<div class="health-check-tools-accordion">
		<div class="accordion-section">
			<h3 class="accordion-section-title"><?php esc_html_e( 'File Integrity', 'health-check' ); ?></h3>
		...
		<div class="accordion-section">
			<h3 class="accordion-section-title"><?php esc_html_e( 'Mail Check', 'health-check' ); ?></h3>
			<div class="accordion-section-content">
				<p>
